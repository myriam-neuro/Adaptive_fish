...
path_artificial= r'C:\\Users\HAMON\Fish_movements\Artificial_Fish'
file_names_artificial = glob.glob(os.path.join(path_artificial, "*.csv"))

path_real= r'C:\\Users\HAMON\Fish_movements\Real_Fish'
file_names_real_two_fish = glob.glob(os.path.join(path_real, "*.xlsx"))

'''path_real_one_fish  = r'C:\\Users\HAMON\Fish_movements\Real_Fish\Robotracker'
file_names_real_one_fish = glob.glob(os.path.join(path_real_one_fish, "*.xlsx"))'''

path_robot= r'C:\\Users\HAMON\Fish_movements\Artificial_Fish'
...
if partner:
    ...
    Training_data_fake = np.concatenate((Training_data_artificial_1,Training_data_artificial_2,Training_data_robot ))
